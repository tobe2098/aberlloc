#ifndef _LINKED_ARENA_HEADER
#define _LINKED_ARENA_HEADER
// #include <pthread.h>
#include <stdint.h>
#include <stdlib.h>
#include "./utils.h"
...
typedef struct LinkedArena {
    ...
    int auto_align_;
    int alignment_;
    // LinkedArena*    __parent;
} LinkedArena;

int Init_StaticArena(LinkedArena* arena, int arena_size, int auto_align) {
#ifdef DEBUG
  if (arena == NULL) {
...
int Destroy_StaticArena(LinkedArena* arena) {
#ifdef DEBUG
  if (arena == NULL) {
    return ERROR_INVALID_PARAMS;
  }
...
int SetAutoAlign2Pow_StaticArena(LinkedArena* arena, int alignment) {
#ifdef DEBUG
  if (arena == NULL) {
    return ERROR_INVALID_PARAMS;
  }
...
uintptr_t GetPos_StaticArena(LinkedArena* arena) {
#ifdef DEBUG
  if (arena == NULL) {
    return NULL;
  }
...
int PushAligner_StaticArena(LinkedArena* arena, int alignment) {
#ifdef DEBUG
  if (arena == NULL) {
    return ERROR_INVALID_PARAMS;
  }
...
int PushAlignerCacheLine_StaticArena(LinkedArena* arena) {
#ifdef DEBUG
  if (arena == NULL) {
    return ERROR_INVALID_PARAMS;
  }
...
uint8_t* PushNoZero_StaticArena(LinkedArena* arena, int bytes) {
#ifdef DEBUG
  if (arena == NULL) {
    return NULL;
  }
...
uint8_t* Push_StaticArena(LinkedArena* arena, int bytes) {
#ifdef DEBUG
  if (arena == NULL) {
    return NULL;
  }
...
int Pop_StaticArena(LinkedArena* arena, uintptr_t bytes) {
...
int PopTo_StaticArena(LinkedArena* arena, uintptr_t position) {
#ifdef DEBUG
  if (arena == NULL) {
    return ERROR_INVALID_PARAMS;
  }
...
int PopToAdress_StaticArena(LinkedArena* arena, uint8_t* address) {
#ifdef DEBUG
  if (arena == NULL) {
    return ERROR_INVALID_PARAMS;
  }
...
int Clear_StaticArena(LinkedArena* arena) {
#ifdef DEBUG
  if (arena == NULL) {
    return ERROR_INVALID_PARAMS;
  }
...
int InitScratch_StaticArena(LinkedArena* scratch_space, LinkedArena* arena, int arena_size, int auto_align) {
#ifdef DEBUG
...
int DestroyScratch_StaticArena(LinkedArena* scratch_space, LinkedArena* parent_arena) {
...
int MergeScratch_StaticArena(LinkedArena* scratch_space, LinkedArena* parent_arena) {
